# 28-vouchfor - Base Native Architecture
...
VouchFor provides a decentralized solution for reputation through vouching on both Base (EVM) and Stacks blockchains.
